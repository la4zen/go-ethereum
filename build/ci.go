...
import (
	...
	"github.com/la4zen/go-ethereum/crypto/signify"
	"github.com/la4zen/go-ethereum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/la4zen/go-ethereum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/la4zen/go-ethereum/internal/version.gitDate="+env.Date)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/la4zen/go-ethereum/core/rawdb", "github.com/la4zen/go-ethereum/ethdb/leveldb"},
		{"github.com/la4zen/go-ethereum/core/rawdb", "github.com/la4zen/go-ethereum/ethdb/pebbledb"},
	}
